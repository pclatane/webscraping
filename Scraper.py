...
##https://rentechdigital.com/smartscraper/review-scraping
...
for link in productlinks:
    ...
    try:
        stock=hun.find("p",{"class":"product-action__stock-flag"}).text.replace('\n',"")
    except:
        stock=None
        
    whisky = {"name":name,"price":price,"rating":rating,"about":about,"stock":stock}
